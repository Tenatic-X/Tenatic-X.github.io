...
## Relevant work
[09. Milestone Project 2: SkimLit 📄🔥 (study)](https://tenatic-x.github.io/projects/(study)%2009_milestone_project_2_skimlit.html)
...
```python
Epoch 1/1000
5627/5627 ━━━━━━━━━━━━━━━━━━━━ 1357s 239ms/step - accuracy: 0.7820 - loss: 1.0113 - val_accuracy: 0.8475 - val_loss: 0.9084
Epoch 2/1000
5627/5627 ━━━━━━━━━━━━━━━━━━━━ 1341s 238ms/step - accuracy: 0.8510 - loss: 0.9143 - val_accuracy: 0.8536 - val_loss: 0.8991
Epoch 3/1000
5627/5627 ━━━━━━━━━━━━━━━━━━━━ 1342s 238ms/step - accuracy: 0.8600 - loss: 0.9012 - val_accuracy: 0.8544 - val_loss: 0.8975
Epoch 4/1000
5627/5627 ━━━━━━━━━━━━━━━━━━━━ 1342s 239ms/step - accuracy: 0.8671 - loss: 0.8921 - val_accuracy: 0.8550 - val_loss: 0.8971
Epoch 5/1000
5627/5627 ━━━━━━━━━━━━━━━━━━━━ 1354s 241ms/step - accuracy: 0.8720 - loss: 0.8853 - val_accuracy: 0.8551 - val_loss: 0.8973
Epoch 6/1000
5627/5627 ━━━━━━━━━━━━━━━━━━━━ 1375s 236ms/step - accuracy: 0.8761 - loss: 0.8790 - val_accuracy: 0.8544 - val_loss: 0.8973
Epoch 7/1000
5627/5627 ━━━━━━━━━━━━━━━━━━━━ 1374s 241ms/step - accuracy: 0.8797 - loss: 0.8738 - val_accuracy: 0.8535 - val_loss: 0.8987
```
...
```python
embedding_matrix = np.zeros((len(vocab)+1, EMBEDDING_DIM)) # form embed matrix by the length of our data vocab, with the stated 300 dims
hits=0
miss=0

for word,i in vocab_index.items(): # go thru every word in vocab index dict
    vector = embedding_index.get(word) # go thru gloVe embed to get the 'word' pulled from our data vocab
    if vector is not None: # if found successfully
        embedding_matrix[i] = vector # change the vector value present in gloVe, with the vector value from dataset
        hits+=1 # keep track of words  that were converted
    else:
        miss+=1 # keep track of the ones that were missed
```
